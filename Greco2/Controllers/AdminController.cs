...
namespace Greco2.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        ********************************/
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult CrearTipoDeEvento(string Nombre,bool esAgendable)
        {
            ...
            if (!String.IsNullOrEmpty(Nombre))
            {
                ...
                {
                    var tipoEvento = tecs.createTipoEvento(Nombre,esAgendable);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult guardarTipoDeEventoEditado(int id, string Nombre,bool esAgendableEdicion,string campoActivacion)
        {
            var tecs = new TipoEventoCommandService();
            ...
            if (!String.IsNullOrEmpty(Nombre))
            {
                ...
                else
                {
                    ...
                    tipoEvento.Id = id;
                    tipoEvento.Nombre = Nombre.ToUpper();
                    tipoEvento.Agendable = esAgendableEdicion;
                    tipoEvento.Deleted = (campoActivacion == "on");
