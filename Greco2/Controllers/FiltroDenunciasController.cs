...
namespace Greco2.Controllers
{
    ...
    public class FiltroDenunciasController : Controller
    {
        ...
        public void GenerarExcelZipActivas()
        {
            ...
            {
                lista = context.Database
                        .SqlQuery<ListaSabanaSP>("ExcelGetDenunciasPorFechaDeNotificacionHasta @fechaHasta", new SqlParameter("@fechaHasta", fechaHasta))
                        .ToList();
                //lista = context.Database
                //        .SqlQuery<ListaSabanaSP>("ExcelGetListaSabana")
                //        .ToList();
        ...
        {
            List<ListaSabanaFull> lista = new List<ListaSabanaFull>();
            var fechaHasta = DateTime.Now;
            using (NuevoDbContext context = new NuevoDbContext())
            {
                lista = context.Database
                        .SqlQuery<ListaSabanaFull>("GetDenunciasFullData")
                        .ToList();
                //lista = context.Database
                //        .SqlQuery<ListaSabanaSP>("ExcelGetDenunciasPorFechaDeNotificacionHasta @fechaHasta",new SqlParameter("@fechaHasta", fechaHasta))
                //        .ToList();
